...
const SU_Member = require("../../../model/super/memberSU");

async function loginSUCTR(req, res, next) {
  const data = req.body;
  try {
    if (!data.email || !data.password) {
      ...
      const existingMember = await SU_Member.findOne({
